package br.dev.robsonjunior.todo.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.dev.robsonjunior.todo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.dev.robsonjunior.todo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
