...
describe('Collaborator Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'collaborator', component: CollaboratorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.collaborators?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to collaboratorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCollaboratorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCollaboratorIdentifier).toHaveBeenCalledWith(entity);
