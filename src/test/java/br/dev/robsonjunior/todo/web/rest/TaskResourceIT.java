...
class TaskResourceIT {
    ...
    private static final Long DEFAULT_HOURS_TO_COMPLETE = 0L;
    private static final Long UPDATED_HOURS_TO_COMPLETE = 1L;
    private static final Long SMALLER_HOURS_TO_COMPLETE = 0L - 1L;
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task()
            ...
            .hoursToComplete(DEFAULT_HOURS_TO_COMPLETE)
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task()
            ...
            .hoursToComplete(UPDATED_HOURS_TO_COMPLETE)
        ...
        Sprint sprint;
        if (TestUtil.findAll(em, Sprint.class).isEmpty()) {
            sprint = SprintResourceIT.createUpdatedEntity(em);
            em.persist(sprint);
            em.flush();
        } else {
            sprint = TestUtil.findAll(em, Sprint.class).get(0);
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getHoursToComplete()).isEqualTo(DEFAULT_HOURS_TO_COMPLETE);
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].hoursToComplete").value(hasItem(DEFAULT_HOURS_TO_COMPLETE.intValue())))
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.hoursToComplete").value(DEFAULT_HOURS_TO_COMPLETE.intValue()))
    ...
    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsEqualToSomething() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);
    ...
    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsInShouldWork() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);
    ...
    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsNullOrNotNull() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);

        // Get all the taskList where hoursToComplete is not null
        defaultTaskShouldBeFound("hoursToComplete.specified=true");

        // Get all the taskList where hoursToComplete is null
        defaultTaskShouldNotBeFound("hoursToComplete.specified=false");
    }

    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);
    ...
    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);
    ...
    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsLessThanSomething() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);
    ...
    @Test
    @Transactional
    void getAllTasksByHoursToCompleteIsGreaterThanSomething() throws Exception {
        // Initialize the database
        taskRepository.saveAndFlush(task);
    ...
    @Test
    @Transactional
    void getAllTasksBySprintIsEqualToSomething() throws Exception {
        Sprint sprint;
        if (TestUtil.findAll(em, Sprint.class).isEmpty()) {
            taskRepository.saveAndFlush(task);
            sprint = SprintResourceIT.createEntity(em);
        ...
        // Get all the taskList where sprint equals to sprintId
        defaultTaskShouldBeFound("sprintId.equals=" + sprintId);

        // Get all the taskList where sprint equals to (sprintId + 1)
        defaultTaskShouldNotBeFound("sprintId.equals=" + (sprintId + 1));
    }

    @Test
    @Transactional
    void getAllTasksByCollaboratorIsEqualToSomething() throws Exception {
        ...
        // Get all the taskList where collaborator equals to collaboratorId
        defaultTaskShouldBeFound("collaboratorId.equals=" + collaboratorId);

        // Get all the taskList where collaborator equals to (collaboratorId + 1)
        defaultTaskShouldNotBeFound("collaboratorId.equals=" + (collaboratorId + 1));
    }
    ...
    void putExistingTask() throws Exception {
        ...
        assertThat(testTask.getHoursToComplete()).isEqualTo(UPDATED_HOURS_TO_COMPLETE);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).hoursToComplete(UPDATED_HOURS_TO_COMPLETE);
